...
// this component for the cards used in the centre(main blogs of the wen=bsite with the like comment icons)
const CentreCard = ({name,content}:centerprops) => {
  return (
    <div className='px-6 w-full mb-8 border py-6 flex flex-col gap-4 shadow-lg '>
